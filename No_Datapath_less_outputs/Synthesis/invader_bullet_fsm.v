...
#(
    ...
    input wire [3:0] closest_invader_coord_x,
    input wire [3:0] closest_invader_coord_y,

    output reg invader_bullet_display,
    output reg [3:0] invader_bullet_coord_x,
    output reg [3:0] invader_bullet_coord_y,
    ...
    always @ (negedge clkb) begin : OUTPUT_LOGIC
        if (reset) begin
            ...
            invader_bullet_coord_x <= 4'd12;
            invader_bullet_coord_y <= 4'd14;
        end else begin
            case (next_state)
                INITIAL: begin
                    state <= next_state;
