...
module top
    ...
    output wire [1:0]       player_state,                       // Player state
    output wire [1:0]       shield_state,                       // Shield state
    output wire [1:0]       invader_state_1,                    // Invader state 1
    output wire [1:0]       invader_state_2                    // Invader state 1
    );
