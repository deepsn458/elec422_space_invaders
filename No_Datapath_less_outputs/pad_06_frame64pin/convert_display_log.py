...
REQUIRED_FIELDS = [
    ...
    "p_pb_x",
    "p_pb_y",
    "p_player_bullet_display",
    "p_ib_x",
    "p_ib_y",
    "p_invader_bullet_display",
]
...
def format_frame(frame: Dict[str, str]) -> str:
    ...
    return "\n".join(
        [
            ...
            f"player  {int(frame['p_player_x'],2)} {int(str(frame['p_player_display']),2)}",
            f"invader_1  {int(frame['p_inv1_x'],2)} {int(frame['p_inv1_y'],2)} {int(frame['p_invader_1_display'],2)}",
            f"invader_2  {int(frame['p_inv2_x'],2)} {int(frame['p_inv2_y'],2)} {int(frame['p_invader_2_display'],2)}",
            f"shield  7  4 {int(frame['p_s_hp'],2)}",
            f"player_bullet  {int(frame['p_pb_x'],2)}  {int(frame['p_pb_y'],2)} {int(frame['p_player_bullet_display'],2)}",
            f"invader_bullet  {int(frame['p_ib_x'],2)}  {int(frame['p_ib_y'],2)} {int(frame['p_invader_bullet_display'],2)}",
            "END_FRAME",
        ]
    )
